            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM users WHERE username ='$lecturerId'";
                        $result = mysqli_query($conn, $sql) or die(mysqli_error($conn));
                        $lecturerQuery = mysqli_fetch_array($result);
                        $lecturerIDNumber = $lecturerQuery['id'];
                        ...
                        else
                        {
                          ...
                          $query = "SELECT * FROM users u LEFT JOIN lecturers l ON u.id = l.student_id Where lecturer_id = '$lecturerIDNumber'";
                        }
