...
<body onload="SetDate();">
				      ...
				      <div class="col-md-9 personal-info">
				        ...
				        <?php 
					        ...
					        <div class="form-group">
					          ...
					          <div class="form-group">
								<label class="col-md-3 control-label" for="nmarks">student id</label>
								 <div class="col-md-8">
				                  <input id="rank" class="form-group form-control"  name="nmarks" style="margin-left: -1px;" required>
	...
	<script>
		function goBack() {
			window.location.href = '../home/profHome.php';
		}
	</script>
</body>
</html>
				...
				foreach ($_POST['lecturers'] as $amarkers) {
					if (isset($_POST['sname']) && isset($_POST['sdesc']) && isset($_POST['sweight']) && isset($_POST['schoice']) && isset($_POST['sdeadline'])) {
						...
						foreach ($_POST['sname'] as $key => $value) {
							...
							$query = "INSERT INTO `assignment` (`course id`, `course name`, `assignment name`, `weight`, `description`, `deadline`, `student id`) VALUES ('666', '$aname1', '$aname1', '$aweight1', '$adesc', '$adeadline1', '$anmarkers')";
